...
export const TRANSLATIONS = {
  en: {
    ...
    pdf_only_notice_title: '📄 PDF Files Only (Word / Excel / PPT / Images Not Accepted Directly)',
    pdf_only_notice_desc: 'Word (.doc/.docx), Excel, PowerPoint (PPT) and Image files cannot be uploaded directly. Please convert your Word / Excel / PPT / Image file to PDF first, then upload the PDF here. (Tip: In MS Word/Excel/PPT, use File → Save As → PDF or Export to PDF).',
  ...
  ta: {
    ...
    pdf_only_notice_title: '📄 PDF கோப்புகள் மட்டுமே (Word / Excel / PPT / படங்கள் நேரடியாக ஏற்றுக்கொள்ளப்படாது)',
    pdf_only_notice_desc: 'Word, Excel, PowerPoint மற்றும் பட கோப்புகளை நேரடியாக பதிவேற்ற முடியாது. உங்கள் கோப்பை முதலில் PDF ஆக மாற்றி, பின்னர் பதிவேற்றவும். (குறிப்பு: MS Word இல் File → Save As → PDF பயன்படுத்தவும்).',
  ...
  tanglish: {
    ...
    pdf_only_notice_title: '📄 PDF Files Only (Word / Excel / PPT / Images Direct-a Upload Panna Mudiyathu)',
    pdf_only_notice_desc: 'Word (.doc/.docx), Excel, PowerPoint (PPT) & Image files-a direct-a upload panna mudiyathu. Unga Word/Excel/PPT file-a PDF-a convert panni approm upload pannunga. (Tip: MS Word-la File → Save As → PDF use pannunga).',
